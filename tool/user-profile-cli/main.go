...
import (
	...
	"github.com/JormungandrK/microservice-user-profile/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "user-profile-cli",
		Short: `CLI client for the user-profile service`,
	}
	...
	c.UserAgent = "user-profile-cli/1.0"
